    ...
    <div class="trace-container">
        <div class="button-container">
            <el-button type="primary" style="margin-bottom: 20px; font-size: 40px; font-weight: bold;"
                @click="actionInfo">管理员操作溯源信息查询</el-button>
            <div v-if="showaction">
            ...
            <el-button type="primary" style="margin-bottom: 20px; font-size: 40px; font-weight: bold;"
                @click="balanceInfo">管理员账户余额信息查询</el-button>
            ...
            <el-button type="primary" style="margin-bottom: 20px; font-size: 40px; font-weight: bold;"
                @click="offerInfo">系统所有报价信息查询</el-button>
            <div v-if="showoffer">
            ...
            <el-button type="primary" style="margin-bottom: 20px; font-size: 40px; font-weight: bold;"
                @click="contractInfo">系统所有合同信息查询</el-button>
...
export default {
    ...
    methods: {
        ...
        actionInfo() {
            ...
            if (this.showaction && this.adminActiondata.length === 0) {
